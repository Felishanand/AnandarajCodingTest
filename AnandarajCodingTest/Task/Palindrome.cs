...
namespace AnandarajCodingTest.Task
{
    public class Palindrome
    {
        ...
        private static void countFreq(char[] str, int[] freq, int n)
        {
            for (int i = 0; i < n; i++)
                freq[str[i] - 'a']++;
        }
        ...
        private static Boolean canMakePalindrome(int[] freq, int n)
        {
        ...
        // char is not present
        private static char findOddAndRemoveItsFreq(int[] freq)
        {
            char odd_char = 'a';
        ...
        private static Boolean findPalindromicString(char[] str, int n)
        {
        ...
        private static Boolean nextPalin(char[] str, int n)
        {
        ...
        public void PrintAllPalinPermutations(char[] str, int n)
        {
